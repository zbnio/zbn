...
def reg_config(app):
    ...
    # db_host = os.getenv('ZBN_DB_HOST', None)
    # db_port = int(os.getenv('ZBN_DB_PORT', 3306))
    # db_user = os.getenv('ZBN_DB_USER', None)
    # db_password = os.getenv('ZBN_DB_PASSWORD', None)
    # db_database = os.getenv('ZBN_DB_DATABASE', None)
    # redis_host = os.getenv('ZBN_REDIS_HOST', None)
    # redis_port = int(os.getenv('ZBN_REDIS_PORT', 6379))
    # redis_database = os.getenv('ZBN_REDIS_DATABASE', 0)
    # redis_password = os.getenv('ZBN_REDIS_PASSWORD', '')
...
def create_app():
    app = Flask(__name__, static_folder='web_html/dist', static_url_path='/html')
